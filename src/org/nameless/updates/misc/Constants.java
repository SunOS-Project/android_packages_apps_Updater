...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "ro.nameless.build_date_utc";
    public static final String PROP_BUILD_TYPE = "ro.nameless.build_type";
    ...
    public static final String DOWNLOAD_PATH = "/data/nameless_ota/";
    ...
    static final String CHANGELOG_URL = "https://github.com/Nameless-AOSP/OTA/blob/%s/%s/changelog_%s.txt";
